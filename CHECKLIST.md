...
- [x] Multi-provider support — SDK has Anthropic + OpenAI + Gemini ✅
- [x] Streaming responses — TrackedClient.stream() with SSE (Stage 3)
- [x] Event-based architecture — Redis Streams XADD in emitter.py ✅
- [x] PII redaction — Presidio sidecar running + 2-stage strategy ✅
- [ ] Latency + Throughput + Error dashboards — Stage 6
- [ ] Docker Compose one-command setup — needs frontend scaffold (Stage 5)
